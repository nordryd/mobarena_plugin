...
public enum PluginCommand
{
    ...
    public static final String MASTER_CMD_PREFIX = "marena";
    ...
    public String getUsage() {
        return ChatColor.DARK_RED + "USAGE: " + ChatColor.RED + "/" + MASTER_CMD_PREFIX + " " + getCommand() +
                stream(parameters).map(param -> " [" + param + "]").collect(joining()) + ChatColor.RESET;
    }

    @Override
    public String toString() {
        final StringBuilder strBuilder = new StringBuilder("/" + MASTER_CMD_PREFIX + " " + this.command);
